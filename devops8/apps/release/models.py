...
class Deploy(models.Model):
    ...
    applicant       = models.ForeignKey(User, verbose_name=u'申请人', related_name="applicant", on_delete=models.CASCADE,)
    reviewer        = models.ForeignKey(User, verbose_name=u'审核人', related_name="reviewer", on_delete=models.CASCADE,)
    assign_to       = models.ForeignKey(User, verbose_name=u'上线人',null=True, blank=True, related_name="assigned", on_delete=models.CASCADE,)
