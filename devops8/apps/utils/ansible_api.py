...
class ANSRunner(object):
    ...
    def __initializeData(self):
        ...
        self.loader = DataLoader()
        # 需要指定SSH登录使用的管理账号，即remote_user的值
        # 我是用的管理账号名是ansible
        self.options = Options(connection='smart', module_path=None, forks=100, timeout=10,
                               remote_user='ansible', ask_pass=False, private_key_file=None, ssh_common_args=None,
                               ssh_extra_args=None,
...
if __name__ == '__main__':
    rbt = ANSRunner()
    rbt.run_playbook(playbook_path='/root/test.yaml')
